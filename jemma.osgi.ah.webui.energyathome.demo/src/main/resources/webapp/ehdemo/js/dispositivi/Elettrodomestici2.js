...
$(document).ready(function() {
	...
	(function ($) {
	    ...
	    $(window).on('resize', function (event) {
	    	...
	    	if ( (!Modernizr.touch)&&(window.innerWidth!=widthMeasured) ){
	    		resize=true;
...
function impostaAltezzeElettrodomestici(){
	...
	if ( (Modernizr.touch) && (window.innerHeight==1232) && (Menu.contentMenuSelected===2) ){
...
//		$("#RigaElettrodomestici").css("min-height", "200px");
...
//	}
	...
	if ((!Modernizr.touch) && (window.innerHeight<743)){
		$("#RigaElettrodomestici").css("height", "260px");
		$("#RigaElettrodomestici").css("min-height", "260px");
		//$("#Elettrodomestici").css("height", "auto");
	}
...
Elettrodomestici.refreshDevices=function(){
	...
	if( (window.innerWidth<=widthSmartphone) || ( (window.innerHeight<=widthSmartphone) && (Modernizr.touch) ) ) {
